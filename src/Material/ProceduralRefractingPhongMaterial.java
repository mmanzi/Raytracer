 ...
 */
public  class ProceduralRefractingPhongMaterial extends Material{
	...
	public ProceduralRefractingPhongMaterial(RGBColor dcolor,RGBColor acolor,RGBColor scolor,float s,float r,Tracer t,float ref,float refra,ProceduralTexture tex){
		super();
