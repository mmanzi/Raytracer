...
public class Scene1 extends World{
	...
	//	Material redMat = new DiffuseMaterial(new RGBColor(1.f, 0.5f, 0.5f));
		...
		//Add light sources
		Light light = new MovableLight(new Point3f(0f, 0.2f,-4.f),new RGBColor(1f,1f,1f));
		lights.add(light);
		//Light lightd = new DirectionalLight(new Vector3f(0.f,1.f,0f),new RGBColor(0.8f,0.8f,0.8f));
		//lights.add(lightd);
		RefractingPhongMaterial rpm = new RefractingPhongMaterial(new RGBColor(0.f, 0.f, 0.f), new RGBColor(0.0f, 0.0f, 0.0f), new RGBColor(0.0f, 0.f, 0.0f), 300.f,0.f,t,1.5f);
