...
//										1000); 						// rays per pixel
		...
		Material phongMat = new PhongMaterial(new RGBColor(0.5f, 0.5f, 0.5f), new RGBColor(0.0f, 0.01f, 0.0f), new RGBColor(0.5f, 0.5f, 0.5f), 200.f);
		Material mirrorMat = new MirrorPhongMaterial(new RGBColor(0.5f, 0.5f, 0.5f), new RGBColor(0.0f, 0.01f, 0.0f), new RGBColor(0.5f, 0.5f, 0.5f), 200.f, 0.5f,t);
//		Material redMat = new DiffuseMaterial(new RGBColor(1f, 0.f, 0f));
			

	//	Material redMat = new DiffuseMaterial(new RGBColor(1.f, 0.5f, 0f));
		
//		Cuboid thingy = new Cuboid(phongMat, new Point3f(0f, 0f, 0f), new Vector3f(1f, 0f, 0f), 2f, 4f, new Vector3f(0f, 0f, -1f), 6f);
//		Rectangle thingy = new Rectangle(redMat, new Point3f(-1f, 1f, -5f), new Vector3f(0f, 1f, 0f), new Vector3f(0f, 0f, -1f), 2f, 2f);
//		objects.add(thingy);

		Sphere sphere = new Sphere(phongMat, new Point3f(3f, 0f, 0f), 1.5f);
		objects.add(sphere);
		Sphere sphere2 = new Sphere(phongMat, new Point3f(0f, 0f, -7.5f), 1.5f);
		objects.add(sphere2);
...
//		lights.add(light2);
		Light light3 = new MovableLight(new Point3f(3.f, 30.f, 2f),new RGBColor(1f,1f,1f));
		lights.add(light3);
		Light light4 = new MovableLight(new Point3f(-3.f, 30.f, 2f),new RGBColor(1f,1f,1f));
		lights.add(light4);
